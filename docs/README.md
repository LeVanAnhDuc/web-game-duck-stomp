...
| [`02-requirements/nfr.md`](02-requirements/nfr.md) | Ngưỡng nào áp cho **mọi** feature, để không phải nhắc lại … | 🟢 đủ — đã rà theo dự án; các ngưỡng của ser… | thêm loại tài nguyên mới · thêm nhóm người dùng · sau sự c… |
...
| [`../.env.example`](../.env.example) | cần biến nào để chạy được dự án này? | 🟢 đủ — dự án KHÔNG cần biến môi trường nào | code đọc một biến mới (process.env.X / import.meta.env.X /… |
<!-- END:auto -->
